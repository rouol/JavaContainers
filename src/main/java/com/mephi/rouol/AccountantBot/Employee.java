...
public class Employee {
    ...
    private Employee(String givenName, String surName, int age, Gender gender, Role role, Dept dept, String eMail, String phone, String address, String city, String state, int code) {
    ...
    private static final String[] maleNames = {"Артем", "Александр", "Максим", "Даниил",
    ...
    private static final String[] cities = {"Благовещенск", "Архангельск", "Астрахань", "Белгород", "Брянск", "Владимир", "Волгоград",
            ...
            "Мурманск", "Нижний Новгород", "Великий Новгород", "Новосибирск", "Омск", "Оренбург", "Орел",
